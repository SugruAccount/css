...
h1, h2, h3, h4, h5, h6 {
	/*font-weight: bold;*/
	font-family: "CurrysSansHeadline", Arial, sans-serif;
	font-weight: normal;
    margin-top: 0;
    margin-bottom: 15px;
}
...
.c-menu {
    ...
    padding: 0;
    margin: 0;
    /*border-top: 1px solid #7CE602;*/
    /*border-bottom: 1px solid #7CE602;*/
